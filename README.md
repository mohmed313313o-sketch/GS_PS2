...
- علامة مائية على الخلفية: شعار GS أسفل اليسار وشعار GameStation أسفل اليمين (صغيرتان)، والشعارات محفوظة في مجلد `assets/`
- اسم الموقع في المتصفح: موقع GameStation
